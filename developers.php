                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
							...
							<hr>
                                <div class="span3">
										<center>
										<img id="developers" src="developers/logo.jpg"height="100" width="100" class="img-circle">
										<hr>
										<p>Name: Abubakar Sadiq Sani</p>
										<p>Address: Dakwa, Abuja</p>
										<p>Email: abubaarsadiqsani@gmail.com</p>
                                ...
                                <div class="span3">
										<center>
								        <img id="developers" src="developers/Abba.jpg"height="100" width="100" class="img-circle">
								        <hr>
										<p>Name: Muhammad Adamu Shafiu</p>
										<p>Address: Zaria, Kaduna</p>
										<p>Email: adamumuhammadshafiu@gmail.com</p>
