...
<title>Campus Event Platform&nbsp;(C.E.P.)</title>
        ...
        <div class="title_index">
              ...
              <div class="row-fluid">
                <div class="span12"></div>
                    <div class="row-fluid">
                      <div class="span10">
                      <img class="index_logo" src="img/logo.jpg">
                      </div>
                      <div class="span12">
                        <div class="motto">

                        <h3><p>WELCOME&nbsp;&nbsp;TO:</p></h3>
                        <h2><p>Campus Event Platform&nbsp;(C.E.P.)</p></h2>
                        </div>
                      </div>
                    </div>
              </div>
                    ...
                    <ul class="nav navbar-nav" id="footer_nav">
                      <li class="divider-vertical"></li>
                        ...
                        <!-- <li class="divider-vertical"></li> -->
                          ...
                          <li class="active"><a href="history.php"><i class="icon-file"></i>&nbsp;Events</a></li>
                        <!-- <li class="divider-vertical"></li> -->
...
if(isset($_POST['btnLogin'])){
 ...
 <center>
    <footer>
    <p style="color: #fff">Campus Event Platform (C.E.P.) Copyright 2024</p>
    </footer>
</center>
